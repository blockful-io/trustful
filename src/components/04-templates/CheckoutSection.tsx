...
import { TRUSTFUL_SCHEMAS, ROLES } from "@/lib/client/constants";
...
export const CheckoutSection = () => {
  ...
  const handleAttest = async () => {
    ...
    const encodeParam = TRUSTFUL_SCHEMAS.ATTEST_VILLAGER.data;
    ...
    const response = await submitAttest(
      address,
      TRUSTFUL_SCHEMAS.ATTEST_VILLAGER.uid,
                ...
                <Flex className={"items-center"}>
                  {villagerAttestationCount === 1 ? (
                    ...
                    <Text className="text-center text-slate-50 text-base font-normal leading-snug">
                      For being a cherished member of Trustful.
                    </Text>
                  ) : (
                    <Text className="text-center text-slate-50 text-base font-normal leading-snug">
